...
// RunMenu is Lucy [9]. Intel NPU CABI bridge — compile once, infer many, all layers/dtypes.
func RunMenu(reader *bufio.Reader) {
	...
	fmt.Println()
	fmt.Println("╔══════════════════════════════════════════════════════════════════════╗")
	fmt.Println("║  [9] Intel NPU bridge — Loom ↔ libloom_accel_intel.so              ║")
	fmt.Println("║  Log: lucy_testing_output/nine_layer.txt (reset each run)            ║")
	fmt.Println("╚══════════════════════════════════════════════════════════════════════╝")
	fmt.Printf("  Plugin: %s\n", DefaultPluginPath())
	fmt.Printf("  NPU: %s\n", npuNote)
	fmt.Println("  Matrix: 15 layers × FP32/FP16/INT8 × small/medium/large")
	fmt.Println()
	...
	fmt.Println("  [2] Multi-hop demo (Loom → Intel → Loom)")
